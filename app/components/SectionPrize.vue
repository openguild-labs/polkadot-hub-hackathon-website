  ...
  <section id="prize" class="py-8 lg:py-13 lg:px-18 lg:pl-0!">
    ...
    <div ref="prizeContainer" class="prize-card grid grid-cols-1 lg:grid-cols-3 lg:max-w-[90%] mx-auto lg:rounded-tr-[60px] overflow-hidden">
      ...
      <div class="col-span-2 relative flex items-center justify-center">
        <NuxtImg src="/images/Prize BG.webp" alt="Prize" class="w-full h-full object-cover" />
        <NuxtImg ref="prizeImage" src="/images/Prize level up.webp" alt="Prize" class="absolute top-0 left-0 w-full h-full object-contain" />
      </div>
      ...
      <div class="bg-primary p-5 text-white">
        ...
        <div class="flex flex-row lg:gap-6 gap-4 lg:flex-col max-lg:items-end">
          ...
          <p class="lg:text-sm sm:text-xs text-[10px]">
            And other special packages to maximum award the most talented projects, including Ecosystem Grant Subsidies.
          </p>
        </div>
      </div>
    </div>
